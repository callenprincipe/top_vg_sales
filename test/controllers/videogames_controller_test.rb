...
class VideogamesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create videogame" do
    assert_difference("Videogame.count") do
      post videogames_url, params: { videogame: { name: @videogame.name, rank: @videogame.rank, year: @videogame.year } }
    end
  ...
  test "should update videogame" do
    patch videogame_url(@videogame), params: { videogame: { name: @videogame.name, rank: @videogame.rank, year: @videogame.year } }
